export default function Hero() {
  return (
    <div
      className="flex flex-col justify-center gap-8 py-16 pr-12 border-r border-white/[0.06]"
      style={{ minHeight: "calc(100vh - 61px)" }}
    >
      {/* Badge */}
      <div className="inline-flex items-center gap-2 w-fit text-[15px] font-medium tracking-[2px] uppercase text-emerald-400/80 bg-emerald-400/[0.06] border border-emerald-400/20 px-4 py-1.5 rounded-full">
